...
parser.add_argument("--lr", type=float, default=0.001, help="learning rate for encoder training")
...
parser.add_argument("--embedding", type=str, default="after", help="embedding layer to use for prototype computation")
parser.add_argument("--dist_temp", type=float, default=0.5, help="temperature for distance-based weighting")
